...
𝙗𝙞𝙚𝙣𝙫𝙚𝙣𝙞𝙙𝙤 𝙖𝙡 𝙜𝙧𝙪𝙥𝙤 *${mdata.subject}*

𝙚𝙨𝙥𝙚𝙧𝙤 𝙦𝙪𝙚 𝙩𝙚 𝙜𝙪𝙨𝙩𝙚
𝙉𝙪𝙣𝙘𝙖 𝙝𝙖𝙜𝙖𝙨 𝙨𝙥𝙖𝙢 𝙤 𝙩𝙚 𝙙𝙤𝙭𝙚𝙖𝙢𝙤𝙨 𝙂𝙞𝙡
𝘼𝙝 𝙮 𝙣𝙤 𝙤𝙡𝙫𝙞𝙙𝙚𝙨 𝙡𝙚𝙚𝙧 𝙡𝙖 𝙙𝙚𝙘𝙧𝙞𝙥𝙘𝙞𝙤𝙣`
      welcomeBut = [{buttonId:`#menu`,buttonText:{displayText:'menu'},type:1}, {buttonId:`#infogroup`,buttonText:{displayText:'infogroup'},type:1}]
      welcomeButt = { contentText: `${teks}`, footerText: `𝙅𝙖𝙘𝙠𝙨𝙞𝙩𝙤𝘿'𝙆𝙪𝙞𝙣♡`, buttons: welcomeBut, headerType: 6, locationMessage: bosco2.message.locationMessage}
      ...
      out = `𝙂𝙤𝙤𝙙𝙗𝙮𝙚 @${num.split('@')[0]}\n𝘼𝙙𝙞𝙤𝙨 𝙣𝙤 𝙨𝙚 𝙩𝙚 𝙚𝙭𝙩𝙧𝙖𝙣̃𝙖𝙧𝙖, 𝙉𝙤 𝙘𝙤𝙢𝙖𝙨 𝙣𝙖𝙙𝙖 𝙙𝙚𝙡 𝙨𝙪𝙚𝙡𝙤 𝙦𝙪𝙚 𝙚𝙨𝙩𝙖𝙣 𝙚𝙣𝙫𝙚𝙣𝙚𝙣𝙖𝙣𝙙𝙤 𝙥𝙚𝙧𝙧𝙤𝙨, 𝙍𝙖𝙥𝙖 𝙩𝙪 𝙢𝙖𝙙𝙧𝙚.`
